...
Revision ID: 6c48eefc54cc
Revises: 1284339d36ca
Create Date: 2021-07-30 16:03:19.559295
...
revision = '6c48eefc54cc'
down_revision = '1284339d36ca'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_unique_constraint(None, 'clients', ['mac_address'], schema='public')
    op.drop_constraint('clients_service_zone_fkey', 'clients', type_='foreignkey')
    op.drop_constraint('clients_type_client_fkey', 'clients', type_='foreignkey')
    op.create_foreign_key(None, 'clients', 'type_client', ['type_client'], ['id'], source_schema='public', referent_schema='public')
    op.create_foreign_key(None, 'clients', 'service_zone', ['service_zone'], ['id'], source_schema='public', referent_schema='public')
    op.create_unique_constraint(None, 'information_table', ['mac_address'], schema='public')
...
def downgrade():
    ...
    op.drop_constraint(None, 'information_table', schema='public', type_='unique')
    op.drop_constraint(None, 'clients', schema='public', type_='foreignkey')
    op.drop_constraint(None, 'clients', schema='public', type_='foreignkey')
    op.create_foreign_key('clients_type_client_fkey', 'clients', 'type_client', ['type_client'], ['id'])
    op.create_foreign_key('clients_service_zone_fkey', 'clients', 'service_zone', ['service_zone'], ['id'])
    op.drop_constraint(None, 'clients', schema='public', type_='unique')
