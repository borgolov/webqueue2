...
Revision ID: 1284339d36ca
Revises: 7f6547f26fd1
Create Date: 2021-07-30 15:58:20.838173
...
revision = '1284339d36ca'
down_revision = '7f6547f26fd1'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('clients', sa.Column('type_client', sa.Integer(), nullable=False, comment='тип клиента'))
