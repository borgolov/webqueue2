...
Revision ID: 7f6547f26fd1
Revises: 92ad1b4f0ce8
Create Date: 2021-07-30 15:24:30.582088
...
revision = '7f6547f26fd1'
down_revision = '92ad1b4f0ce8'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('information_table', sa.Column('mac_address', sa.String(length=48), nullable=False, comment='Мак адрес'))
...
def downgrade():
    ...
    op.drop_column('information_table', 'mac_address')
